...
`).map(e=>e.replace(/\r$/,``));if(r.length<2)return c=!0,o.movies;let i=p(r[0]),a={};i.forEach((e,t)=>{a[e.trim()]=t});let l=Object.keys(e),h=0;for(let e=1;e<r.length;e++){if(!r[e].trim())continue;let t=p(r[e]),n=m(t[a.Title]);if(!n)continue;h++;let i={id:h,title:n,titleJP:m(t[a[`Title (Japanese)`]])||``,year:m(t[a.Year])||``,imdbScore:m(t[a[`IMDB Score`]])||m(t[a.IMDB])||``,rottenScore:m(t[a[`Rotten Tomato`]])||m(t[a.Rotten])||``,posterUrl:null};o.movies.push(i),s.movieById.set(h,i),u(h,n),i.titleJP&&u(h,i.titleJP);for(let e of l){let n=a[`${e} Video`],r=a[`${e} Audio`];if(n===void 0)continue;let i=m(t[n])||`-`,c=m(t[r])||`-`;if(i===`-`&&c===`-`)continue;let l=s.countryByCode.get(e);if(!l)continue;let u=o.qualities.length,p={movieId:h,countryId:l.id,videoFormat:i,audioFormat:c};o.qualities.push(p),d(s.videoFormat,i,u),d(s.audioFormat,c,u),f(s.movieQualities,h,u),f(s.countryQualities,l.id,u)}}return c=!0,console.log(`DB loaded: ${o.movies.length} movies, ${o.countries.length} countries, ${o.qualities.length} quality records`),o.movies}function g(e,t){if(!e||!e.trim())return[];let n=e.toLowerCase().trim(),r=new Map;function i(e,t){r.set(e,(r.get(e)||0)+t)}for(let e of o.movies){let t=e.title.toLowerCase();t===n?i(e.id,1e3):t.startsWith(n)&&i(e.id,500)}if(n.length>=3){let e=[];for(let t=0;t<=n.length-3;t++){let r=n.substring(t,t+3),i=s.titleTrigrams.get(r);i&&e.push(i)}if(e.length>0){let t=new Map;for(let n of e)for(let e of n)t.set(e,(t.get(e)||0)+1);for(let[n,r]of t){let t=r/e.length;t>=.5&&i(n,t*200)}}}let a=n.split(/\s+/).filter(e=>e.length>=2);for(let e of a){let t=s.titleWords.get(e);if(t)for(let e of t)i(e,100);if(e.length>=3)for(let t=0;t<=e.length-3;t++){let n=e.substring(t,t+3),r=s.titleTrigrams.get(n);if(r)for(let e of r)i(e,10)}}for(let e of o.movies)e.titleJP&&e.titleJP.includes(n)&&i(e.id,300);return[...r.entries()].sort((e,t)=>t[1]-e[1]).slice(0,50).map(([e])=>s.movieById.get(e)).filter(Boolean)}function _(e){let t=s.movieQualities.get(e)||[],n={};for(let e of t){let t=o.qualities[e],r=o.countries.find(e=>e.id===t.countryId);r&&(n[r.countryCode]={video:t.videoFormat,audio:t.audioFormat})}return n}var v=`bda8d46b3b1b9c717d1d3448901c2a93`,y=`https://api.themoviedb.org/3`,b=`https://image.tmdb.org/t/p`,x=`tmdb_poster_cache`,S=`tmdb_poster_cache_v`,C=3,w=T();function T(){try{return parseInt(localStorage.getItem(S)||`0`)<C?(localStorage.removeItem(x),localStorage.setItem(S,String(C)),{}):JSON.parse(localStorage.getItem(x)||`{}`)}catch{return{}}}function E(){try{let e=Object.keys(w);e.length>3e3&&e.slice(0,e.length-2e3).forEach(e=>delete w[e]),localStorage.setItem(x,JSON.stringify(w))}catch{}}function D(e,t){if(!e||e.length===0)return null;let n=t.toLowerCase();return(e.find(e=>(e.title||e.name||``).toLowerCase()===n)||e[0]).poster_path||null}async function O(e,t,n=`w342`){let r=`${e}_${t}`;if(w[r]!==void 0)return w[r]?`${b}/${n}${w[r]}`:null;try{let i=new URLSearchParams({api_key:v,query:e,language:`en-US`});t&&i.set(`year`,t);let a=await(await fetch(`${y}/search/movie?${i}`)).json(),o=D(a.results,e);if(!o||a.results&&!a.results.find(t=>t.title&&t.title.toLowerCase()===e.toLowerCase())){let t=new URLSearchParams({api_key:v,query:e,language:`en-US`}),n=await(await fetch(`${y}/search/tv?${t}`)).json(),r=D(n.results,e);r&&n.results&&n.results.find(t=>(t.name||``).toLowerCase()===e.toLowerCase())?o=r:o||=r}return w[r]=o||null,E(),o?`${b}/${n}${o}`:null}catch(t){return console.warn(`TMDb error for "${e}":`,t),null}}var k={"Dolby Vision":4,"HDR10+":3,HDR10:3,HDR:3,SDR:1,"-":0,"":0},A={Atmos:3,"Dolby Atmos":3,"5.1":2,Stereo:1,"-":0,"":0};function j(e){return k[e]??0}function M(e){return A[e]??0}function N(e,t){return j(e)*10+M(t)}function P(e,t){if(!e||e===`-`)return`Not Available`;let n=[];return e===`Dolby Vision`||e===`HDR10`||e===`HDR10+`||e===`HDR`?n.push(`4K ${e}`):e===`SDR`?n.push(`HD SDR`):n.push(e),t&&t!==`-`&&n.push(t===`Atmos`?`Dolby Atmos`:t),n.join(` + `)}function F(e){let t={},n=-1,r=``,i=0,a=0,o=0,s=_(e.id);for(let[e,c]of Object.entries(s)){if(!c.video||c.video===`-`)continue;let s=P(c.video,c.audio),l=N(c.video,c.audio);t[s]||(t[s]={label:s,score:l,countries:[]}),t[s].countries.push(e),l>n&&(n=l,r=s),(c.audio===`Atmos`||c.audio===`Dolby Atmos`)&&i++,c.video===`Dolby Vision`&&a++,c.video!==`SDR`&&c.video!==`-`&&o++}let c=Object.values(t).sort((e,t)=>t.score-e.score);return{bestLabel:r,bestScore:n,bestCountries:t[r]?.countries||[],groups:c,atmosCount:i,dvCount:a,fourKCount:o}}var I=[],L=JSON.parse(localStorage.getItem(`watchlist`)||`[]`);function R(){let e=(window.location.hash||`#/`).slice(2).split(`/`);return{page:e[0]||`home`,param:e[1]||``}}function z(e){window.location.hash=`#/`+e}var B=()=>document.getElementById(`page-content`);function V(){let e=R();document.querySelectorAll(`.nav-link`).forEach(t=>{let n=t.dataset.page;t.classList.toggle(`active`,n===e.page||e.page===`search`&&n===`home`)})}async function H(){let e=R();V();let t=B();switch(t.innerHTML=``,t.className=`page-enter`,e.page){case`home`:W(t);break;case`search`:G(t,e.param);break;case`movie`:K(t,e.param);break;case`discover`:q(t);break;case`analytics`:J(t);break;case`watchlist`:Y(t);break;default:W(t)}}function U(e){let t=F(e),n=document.createElement(`a`);n.className=`poster-card`,n.href=`#/movie/${e.id}`;let r=document.createElement(`div`);if(r.className=`poster-image-wrap`,e.poster){let t=document.createElement(`img`);t.className=`poster-image`,t.src=e.poster,t.alt=e.title,t.loading=`lazy`,r.appendChild(t)}else{let t=document.createElement(`div`);t.className=`poster-no-image`,t.textContent=`🎬`,r.appendChild(t),O(e.title,e.year).then(t=>{if(t){e.poster=t;let n=document.createElement(`img`);n.className=`poster-image`,n.src=t,n.alt=e.title,r.innerHTML=``,r.appendChild(n)}})}let i=document.createElement(`div`);i.className=`poster-badges`,t.dvCount>0&&(i.innerHTML+=`<span class="badge badge-dv">DV</span>`),t.atmosCount>0?i.innerHTML+=`<span class="badge badge-atmos">Atmos</span>`:t.fourKCount>0&&(i.innerHTML+=`<span class="badge badge-4k">4K</span>`),r.appendChild(i),n.appendChild(r);let a=document.createElement(`div`);return a.className=`poster-info`,a.innerHTML=`
  ...
  `;let t=document.getElementById(`home-search`);t.addEventListener(`keydown`,e=>{if(e.key===`Enter`){let e=t.value.trim();e&&(z(`search/${encodeURIComponent(e)}`),requestAnimationFrame(()=>{let e=document.getElementById(`search-input`);e&&(e.focus(),e.selectionStart=e.selectionEnd=e.value.length)}))}});let n=I.filter(e=>F(e).dvCount>0&&e.imdbScore).sort((e,t)=>parseFloat(t.imdbScore||0)-parseFloat(e.imdbScore||0)).slice(0,20),r=document.getElementById(`trending-carousel`);n.forEach(e=>r.appendChild(U(e)));let i=I.filter(e=>{let t=F(e);return t.dvCount>0&&t.atmosCount>0}).sort((e,t)=>parseFloat(t.imdbScore||0)-parseFloat(e.imdbScore||0)).slice(0,24),a=document.getElementById(`dv-atmos-grid`);i.forEach(e=>a.appendChild(U(e)))}function G(e,t){let n=decodeURIComponent(t),r=g(n,I);e.innerHTML=`
    <div class="search-container">
      <span class="search-icon">🔍</span>
      <input type="text" class="search-input" id="search-input" value="${Z(n)}" placeholder="Search movies..." autocomplete="off" />
    </div>
    <h2 class="section-title" id="search-count">${r.length} results for "${Z(n)}"</h2>
    <div class="poster-grid" id="search-grid"></div>
  `;let i=document.getElementById(`search-input`),a;function o(){let e=i.value.trim();if(e.length<2)return;let t=g(e,I),n=`#/search/${encodeURIComponent(e)}`;history.replaceState(null,``,n);let r=document.getElementById(`search-count`);r&&(r.textContent=`${t.length} results for "${e}"`);let a=document.getElementById(`search-grid`);a&&(a.innerHTML=``,t.forEach(e=>a.appendChild(U(e))))}i.addEventListener(`input`,()=>{clearTimeout(a),a=setTimeout(o,400)}),i.addEventListener(`keydown`,e=>{e.key===`Enter`&&(clearTimeout(a),o())}),requestAnimationFrame(()=>{i.focus(),i.selectionStart=i.selectionEnd=i.value.length});let s=document.getElementById(`search-grid`);r.forEach(e=>s.appendChild(U(e)))}function K(e,t){let n=I.find(e=>e.id===parseInt(t));if(!n){e.innerHTML=`<p>Movie not found</p>`;return}let r=F(n),i=L.includes(n.id);if(e.innerHTML=`
    ...
    <div class="movie-detail">
      <div class="movie-hero">
        ...
        <div class="movie-hero-info">
          <h1 class="movie-title-main">${Z(n.title)}</h1>
          ${n.titleJP?`<p style="color:var(--text-secondary);font-size:0.95rem">${Z(n.titleJP)}</p>`:``}
  ...
  `,document.getElementById(`back-btn`).onclick=()=>history.back(),O(n.title,n.year,`w500`).then(e=>{let t=document.getElementById(`hero-poster`);e&&(t.innerHTML=`<img src="${e}" alt="${Z(n.title)}" style="width:100%;aspect-ratio:2/3;object-fit:cover" />`)}),r.bestCountries.length>0){let e=document.getElementById(`best-flags`);r.bestCountries.forEach(t=>{e.appendChild(a(t,!0,n.title))})}let o=document.getElementById(`quality-groups`);r.groups.forEach(e=>{let t=document.createElement(`div`);t.className=`quality-group`,t.innerHTML=`<div class="quality-group-label">${e.label} <span style="color:var(--text-muted);font-size:0.8rem">(${e.countries.length} countries)</span></div>`;let r=document.createElement(`div`);r.className=`flag-row`,e.countries.forEach(e=>{r.appendChild(a(e,!0,n.title))}),t.appendChild(r),o.appendChild(t)}),document.getElementById(`watchlist-btn`).onclick=()=>{X(n.id),K(e,t)}}function q(e){e.innerHTML=`
  ...
  `;let t=`imdb-desc`;function n(e,t){let n=[...e];switch(t){case`imdb-desc`:return n.sort((e,t)=>parseFloat(t.imdbScore||0)-parseFloat(e.imdbScore||0));case`imdb-asc`:return n.sort((e,t)=>parseFloat(e.imdbScore||0)-parseFloat(t.imdbScore||0));case`rotten-desc`:return n.sort((e,t)=>parseFloat(t.rottenScore||0)-parseFloat(e.rottenScore||0));case`rotten-asc`:return n.sort((e,t)=>parseFloat(e.rottenScore||0)-parseFloat(t.rottenScore||0));case`year-desc`:return n.sort((e,t)=>parseInt(t.year||0)-parseInt(e.year||0));case`year-asc`:return n.sort((e,t)=>parseInt(e.year||0)-parseInt(t.year||0));case`title-asc`:return n.sort((e,t)=>(e.title||``).localeCompare(t.title||``));case`title-desc`:return n.sort((e,t)=>(t.title||``).localeCompare(e.title||``));default:return n}}let r=[];function i(e){document.querySelectorAll(`.chip`).forEach(t=>t.classList.toggle(`active`,t.dataset.filter===e)),r=I.filter(t=>{let n=F(t);switch(e){case`dv-atmos`:return n.dvCount>0&&n.atmosCount>0;case`dv`:return n.dvCount>0;case`atmos`:return n.atmosCount>0;case`4k`:return n.fourKCount>0;case`jp-hd-abroad-4k`:let e=_(t.id),r=e.JP;if(r&&r.video&&r.video!==`SDR`&&r.video!==`-`)return!1;for(let[t,n]of Object.entries(e))if(t!==`JP`&&n.video&&n.video!==`SDR`&&n.video!==`-`)return!0;return!1;case`major-hd-other-4k`:{let e=_(t.id),n=e=>e&&e!==`SDR`&&e!==`-`;if(n(e.JP?.video)||n(e.US?.video)||n(e.GB?.video))return!1;for(let[t,r]of Object.entries(e))if(t!==`JP`&&t!==`US`&&t!==`GB`&&n(r.video))return!0;return!1}case`all`:return!0;default:return!0}}),a(t)}function a(e){t=e;let i=n(r,e).slice(0,1500),a=document.getElementById(`sort-count`);a&&(a.textContent=`${i.length} movies`);let o=document.getElementById(`discover-grid`);o.innerHTML=``,i.forEach(e=>o.appendChild(U(e)))}document.querySelectorAll(`.chip`).forEach(e=>{e.onclick=()=>i(e.dataset.filter)}),document.getElementById(`sort-select`).onchange=e=>a(e.target.value),i(`dv-atmos`)}function J(t){let i=0,a=0,o=0,s={},c={},l=Object.keys(e);l.forEach(e=>{s[e]=0,c[e]=0}),I.forEach(e=>{let t=F(e);t.atmosCount>0&&i++,t.dvCount>0&&a++,t.fourKCount>0&&o++;let n=_(e.id);for(let[e,t]of Object.entries(n))t.video&&t.video!==`-`&&(c[e]=(c[e]||0)+1,(t.audio===`Atmos`||t.audio===`Dolby Atmos`)&&(s[e]=(s[e]||0)+1))});let u=l.filter(e=>c[e]>0).map(e=>({code:e,name:r(e),atmosPct:c[e]>0?Math.round(s[e]/c[e]*100):0,atmosCount:s[e],total:c[e]})).sort((e,t)=>t.atmosPct-e.atmosPct||t.total-e.total);t.innerHTML=`
    <h1 class="section-title" style="font-size:1.8rem;margin-bottom:24px"><span class="emoji">📊</span> Analytics</h1>
    <div class="stats-grid">
      <div class="stat-card"><div class="stat-number">${I.length.toLocaleString()}</div><div class="stat-label">Total Movies</div></div>
  ...
  `;let d=document.getElementById(`ranking-list`);u.forEach((e,t)=>{let r=document.createElement(`div`);r.className=`ranking-item`,r.innerHTML=`
    ...
    `,d.appendChild(r)})}function Y(e){let t=I.filter(e=>L.includes(e.id)),n=0,r=0;if(t.forEach(e=>{let t=F(e);t.atmosCount>0&&n++,t.dvCount>0&&r++}),e.innerHTML=`
    ...
    `}
  `,t.length>0){let e=document.getElementById(`watchlist-grid`);t.forEach(t=>e.appendChild(U(t)))}}function X(e){let t=L.indexOf(e);t>=0?L.splice(t,1):L.push(e),localStorage.setItem(`watchlist`,JSON.stringify(L))}function Z(e){let t=document.createElement(`div`);return t.textContent=e,t.innerHTML}async function Q(){window.addEventListener(`hashchange`,H);try{I=await h()}catch(e){console.error(`Failed to load movies:`,e)}H()}Q();